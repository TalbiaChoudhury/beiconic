...
// Add this new slide object to your visionSlides array
{
...
},
  {
    ...
    header: 'What Icon Actually Does',
    image: '/assets/images/vision/slide-users.png',
    content: (
    <>
      <p>Icon is a platform where expert coaches craft their own AI trainers — called Icons — to deliver personalised, on-demand coaching at scale.</p>
      <ul className={styles.list}>
        <li className={styles.listItem}>For Coaches: Build, customise, and train your Icon. Set the tone, structure the logic, and stay in control.</li>
        <li className={styles.listItem}>For Clients: Choose the Icon that fits your goals and vibe. Get daily, personalised guidance. Track your progress.</li>
      </ul>
      <p><em>💡 It feels like talking to a real expert — because it is.</em></p>
    </>
  )
  },
  {
